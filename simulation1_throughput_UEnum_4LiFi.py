...
for i in range(len(UE_list)):
    ...
    #############################################################     
        ...
        ATCNN_runtime_list.append(ATCNN_runtime)
        GT_runtime_list.append(GT_runtime)
        SSS_runtime_list.append(SSS_runtime)
        iter_runtime_list.append(iter_runtime)
        FL_runtime_list.append(FL_runtime)
    ...
    csv_thr.update(log_thr, 'figure_data/fig5_Thr_4LiFi_3W.csv')
    print('')
    ...
    csv_fairness.update(log_fairness, 'figure_data/fig6_Fairness_4LiFi_3W.csv')
