...
import numpy as np
import torch
from ATCNN_model import ATCNN_9LiFi, global_dnn_9LiFi
...
Trained_Net_ATCNN = ATCNN_9LiFi(input_dim=user_dim, cond_dim=cond_dim, cond_out_dim=user_dim, output_dim=output_dim)
...
Trained_Net_DNN = global_dnn_9LiFi(input_dim=DNN_input_dim, output_dim=DNN_output_dim)
device = torch.device('cpu')
...
for i in range(len(R)):
    ...
    csv.update(log, 'figure_data/fig7_ThrRb_9LiFi_3W_25UE.csv')
